...
// 2026-07-30: "pipeline" merged into Plan as its Leads tab (Ryan: "Pipeline plan yes") — the whole
// lead → event → route arc is one section now. Operators lose lead visibility by Ryan's explicit
// call: sales is leadership work. Same graceful-fallback story as the goals/stops merge below.

...
function buildRec(a: Complete): Rec {
  ...
  const sci: Record<DrinkId, string> = {
    ...
    tide:  "Whole-food hydration — young coconut water blended with Thai coconut meat and a touch of raw honey (we always name it). Blended to order, never a powder or concentrate.",

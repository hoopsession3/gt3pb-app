...
export const GTM_PLAYS: GtmPlay[] = [
  ...
  { name: "Gym Partnership Program", category: "partnership", status: "planning",
    ...
    inApp: "READY — book via Plan › Bookings; each session is an event (P&L auto). Attribution lands with the GTM tracker (Sprint B)." },
  ...
  { name: "Corporate Wellness Contracts", category: "partnership", status: "planning",
    ...
    inApp: "READY — Plan › Bookings intake + event machinery; the /built one-pager is the pitch leave-behind." },

...
export const DEFAULT_STREAMS: WorkStream[] = [
  { key: "service", icon: "service",    label: "Service",    color: "#5b9a6b", categories: ["stop", "drop", "delivery", "order", "prep"],    sections: ["stops", "prep", "now", "driver"],              owner_role: "operator",      owner_user_id: null, sort: 1 },
  ...
  { key: "business", icon: "business",   label: "Business",   color: "#8b5cf6", categories: ["money", "admin", "strategy", "task", "system"], sections: ["notes", "money", "customers", "pipeline", "team", "goals"], owner_role: "owner",       owner_user_id: null, sort: 5 },
];

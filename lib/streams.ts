...
export const DEFAULT_STREAMS: WorkStream[] = [
  ...
  { key: "business", icon: "business",   label: "Business",   color: "#8b5cf6", categories: ["money", "admin", "strategy", "task", "system"], sections: ["notes", "money", "customers", "pipeline", "team"], owner_role: "owner",       owner_user_id: null, sort: 5 },
];

  ...
  return (
    <section className="screen menu" id="s-menu">
      ...
      <p className="mast-stmt">
        We draw the coffee cold, blend the hydration from whole coconut, and simmer the broth slow — the long way, on purpose — then make every bottle the moment you order it.
      </p>
